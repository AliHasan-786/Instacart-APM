        ...
        <div className="page-content">
            <div className="app-container">
                <div className="settings-page">
                    <h1>⚙️ Privacy & Personalization</h1>
                    ...
                    <div className="settings-section">
                        <div className="settings-section-header">
                            <div className="settings-section-icon amber">⚖️</div>
                            <h2>Your Rights</h2>
                        </div>
                            ...
                            <div className="rights-list">
                                <div className="rights-item" id="download-data-btn">
                                    <div className="rights-item-left">
                                        <span className="rights-item-icon">📥</span>
                                ...
                                <div className="rights-item" id="delete-data-btn">
                                    <div className="rights-item-left">
                                        <span className="rights-item-icon">🗑️</span>
